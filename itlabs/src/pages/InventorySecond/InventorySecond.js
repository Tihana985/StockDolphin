...
export const InventorySecond = () => {
    return (
        <div className={styles.inventorysecond}>
            ...
            <div className={styles.inputsearchcontainers}>
            ...
            <div className={styles.buttonaddcategory}>
                ...
                <button className={styles.addcategory}><span className={styles.text}>ADD CATEGORY</span></button>
            </div>
            ...
            <div className={styles.controlpanel1}>
                <div className={styles.imgcontrolpanel1}>
                    <img src="\img\Control Panel.png" alt="control panel" />
            ...
            <div className={styles.inventorysecondcards}>

                <div className={styles.firstinventorycard}>
                ...
                <div className={styles.secondinventorybox}>
                    ...
                    <div className={styles.thirdpart1}>
                ...
                <div className={styles.thirdinventorybox}>
                    ...
                    <div className={styles.thirdpart2}>
